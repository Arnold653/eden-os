...
import { Home, Receipt, HandCoins, CreditCard, PiggyBank, Settings as Gear, Plus, Trash2, ChevronLeft, ChevronRight, Check, X, BookOpen, Sparkles, Crown, Compass, Clock, HeartPulse, Gauge, GraduationCap, Users, LayoutGrid, Wallet, Download, Upload, Pencil, Copy, Search, Moon, ChevronDown, Droplet, Flame } from 'lucide-react';
  ...
  return (
    <div style={{ marginTop: 4 }}>
      <div style={{ marginBottom: 8 }}>
        ...
        <TextInput placeholder="Passage, réflexion, ce qui a marqué…" value={note} onChange={e => setNote(e.target.value)} />
      </div>
          ...
          <Card style={{ marginBottom: 14 }}>
            <div style={{ display: 'grid', gap: 8 }}>
              <textarea value={texte} onChange={e => setTexte(e.target.value)} placeholder="Qu'as-tu appris aujourd'hui ?" rows={4}
                style={{ width: '100%', border: `1px solid ${C.line}`, borderRadius: 8, padding: '9px 10px', fontSize: 14, fontFamily: 'inherit', resize: 'vertical', background: C.surface, color: C.ink }} />
...
function GrowthNotesJournal({ habit, growthLogs, saveGrowthLogs }) {
  ...
  return (
    <div style={{ marginTop: 4 }}>
      <div style={{ marginBottom: 8 }}>
        <div style={{ fontSize: 10, color: C.fade, marginBottom: 3 }}>Note du jour</div>
        <TextInput placeholder="Ce qui a été concrètement pratiqué…" value={note} onChange={e => setNote(e.target.value)} />
      </div>
      <div style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
        <div style={{ width: 90 }}>
