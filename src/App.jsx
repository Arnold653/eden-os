      ...
      {suggestion && kind === 'revenu' && (
        <Card style={{ marginBottom: 14, border: `1px solid ${C.gold}`, background: C.cream }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
            <span style={{ fontSize: 13, fontWeight: 700, color: C.navy }}>Comment gérer ce revenu de {fmt(suggestion.montant)} ?</span>
          ...
          <div style={{ display: 'grid', gap: 8 }}>
            ...
            <div style={{ borderTop: `1px solid ${C.line}`, paddingTop: 8, display: 'flex', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 700, fontFamily: FONT_MONO, color: C.navy }}>{fmt(suggestion.reste)}</span>
            </div>
          </div>
