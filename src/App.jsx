...
// ---------- Paramètres ----------
function ParametresPanel({ settings, saveSettings, onClose, onExport, onImport, onChangeCurrency }) {
  ...
  return (
    <div style={{ background: C.cream, minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ maxWidth: 460, margin: '0 auto', minHeight: '100vh', background: '#fff', boxShadow: '0 0 30px rgba(0,0,0,0.08)', position: 'relative', paddingBottom: 76 }}>
        ...
        {showSettings && <ParametresPanel settings={settings} saveSettings={saveSettings} onClose={() => setShowSettings(false)} onExport={exportData} onImport={importData} onChangeCurrency={changeCurrency} />}
