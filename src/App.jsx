...
import { Home, Receipt, HandCoins, CreditCard, PiggyBank, Settings as Gear, Plus, Trash2, ChevronLeft, ChevronRight, Check, X, BookOpen, Sparkles, Crown, Compass, Clock, HeartPulse, Gauge, GraduationCap, Users, LayoutGrid, Wallet, Download, Upload, Pencil, Copy, Search, Moon, ChevronDown, Droplet, Flame, Mic } from 'lucide-react';
...
// ---------- Header ----------
function Header({ tab, monthIdx, year, onPrev, onNext, tauxDime, onOpenSettings, onOpenSearch, showBack, onBack }) {
  if (!showBack) {
    return (
      <div style={{
...
export default function App() {
  ...
  // Page d'accueil affichée quand on arrive depuis une notification push (rappel quotidien ou résumé hebdo).
  ...
  return (
    <div style={{ background: C.bg, minHeight: '100vh', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ maxWidth: 460, margin: '0 auto', minHeight: '100vh', background: C.surface, boxShadow: '0 0 30px rgba(0,0,0,0.08)', position: 'relative', paddingBottom: 76 }}>
        ...
        <Header tab={tab} monthIdx={monthIdx} year={year} onPrev={prevMonth} onNext={nextMonth} tauxDime={tauxDime} onOpenSettings={() => setShowSettings(true)} onOpenSearch={() => setShowSearch(true)} showBack={tab !== 'dashboard'} onBack={goBack} />
